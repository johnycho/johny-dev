...
- **톤: 담백한 기술 문장.** 과장·극적 비유를 남발하지 않는다. 특히 **범인·용의자·지배자·우두머리·함정·정체** 같은 수사적·AI스러운 표현은 피하고 **원인·문제 객체·가장 많이 차지하는 것·주의할 점** 등 담백한 말로 쓴다. 비유는 이해를 돕는 선에서 절제해서만.
  - **구어적·비유적 표현 대신 일반적인 기술 용어를 쓴다.** 예: 빡빡한→엄격한, 나눠 갚기→(비용) 분산·줄이기, 짊어지다→맡다·담당하다, 노리다→높이다·우선하다, 내주다→낮아지다, 좀→조금·다소, 열쇠→핵심, 한 몸이 되다→하나로 묶이다, 양날→장단·주의할 점, 딴 살림→따로 존재, 걷어내다→제거하다, 쏟아지다→몰리다, 살리다→지키다.
