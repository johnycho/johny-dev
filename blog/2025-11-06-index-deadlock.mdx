...
<table>
  ...
  <tr><td>1</td><td>idx_user 인덱스 탐색 (Record Lock)</td><td>PK = 10 Row Lock</td></tr>
  <tr><td>2</td><td>PK lookup으로 전환하려 함</td><td>이미 B가 PK 락을 선점</td></tr>
  <tr><td>3</td><td>대기 상태 진입</td><td>A가 idx_user 락을 선점 중</td></tr>
  <tr><td>4</td><td colspan="2" style="text-align: center">서로 상대 락을 기다리며 Deadlock</td></tr>
</table>
